        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Create Form Dosen</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Create Form Dosen</h3>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <select id="pendidikan_akhir" name="pendidikan_akhir" class="custom-select">
        ...
        <option value="S3">Professor</option>
      </select>
    </div>
  </div>
  <div class="form-group row">
    <label for="prodi" class="col-4 col-form-label">Prodi Yang Diajar</label> 
    <div class="col-8">
