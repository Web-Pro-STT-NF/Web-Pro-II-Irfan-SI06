  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Form Mahasiswa</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Update Form Mahasiswa</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="form-group row">
          ...
          <div class="col-8">
            <div class="input-group">
              ...
              <input id="nim" name="nim" value="<?=$mhsedit->nim?>"type="text" class="form-control" value="">
            </div>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-8">
            <div class="input-group">
              ...
              <input id="nama" name="nama" value="<?=$mhsedit->nama?>" type="text" class="form-control" value="">
            </div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-8">
            <div class="input-group">
              ...
              <input id="tgl_lahir" name="tgl_lahir" value="<?=$mhsedit->tgl_lahir?>"type="text" class="form-control" value="">
            </div>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-8">
            <div class="input-group">
              ...
              <input id="tmp_lahir" name="tmp_lahir" value="<?=$mhsedit->tmp_lahir?>" type="text" class="form-control" value="">
            </div>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-8">
          <?php
              $selected_TI = ($mhsedit->prodi_kode=="TI")?"selected":"";
              $selected_SI = ($mhsedit->prodi_kode=="SI")?"selected":"";
              $selected_BD = ($mhsedit->prodi_kode=="BD")?"selected":"";
          ?>
        ...
        <div class="form-group row">
          ...
          <div class="col-8">
            <div class="input-group">
              ...
              <input id="ipk" name="ipk" value="<?=$mhsedit->ipk?>" type="text" class="form-control" value="">
            </div>
          </div>
        </div> 
        <div class="form-group row">
