...
<head>
    ...
    <title>Create Form Mahasiswa</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Create Form Mahasiswa</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Create Form Mahasiswa</h3>
        ...
        <div class="form-group row">
          <label for="prodi" class="col-4 col-form-label">Prodi Yang Dipilih</label> 
          <div class="col-8">
