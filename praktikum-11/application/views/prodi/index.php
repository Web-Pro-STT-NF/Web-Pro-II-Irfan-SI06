...
<body>
  ...
  <div class="content-wrapper">
    ...
    <tbody>
        ...
        ?>
            <td><a href="prodi/view?id=<?=$row->kode;?>"> View |</a>
            <a href="prodi/edit?id=<?=$row->kode;?>"> Edit |</a>
            <a href="prodi/delete?id=<?=$row->kode;?>" onclick='if(!confirm("Anda Ingin Menghapus Data Prodi Ini?")) {return false}'>Delete</a></td></tr>
        <?php
            $nomor++;
            }
        ?>
